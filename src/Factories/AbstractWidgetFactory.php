...
namespace LidyaPos\Widget\Factories;

use LidyaPos\Widget\AbstractWidget;
use LidyaPos\Widget\Contracts\ApplicationWrapperContract;
use LidyaPos\Widget\Misc\InvalidWidgetClassException;
use LidyaPos\Widget\Misc\ViewExpressionTrait;
use LidyaPos\Widget\WidgetId;
use Exception;
